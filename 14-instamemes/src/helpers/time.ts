 ...
 * @returns {string}
 */
export const dateToISOLocale = (date: Date) => {
	return date.toISOString()
}

/**
 * Convert a Date to an `YYYY-MM-DD HH:mm:ss` string
 * @param date
 * @returns {string}
 */
 ...
 * @returns {string}
 */
export const firebaseTimestampToISOLocale = (firebaseTimestamp: Timestamp) => {
	return dateToISOLocale(firebaseTimestampToDate(firebaseTimestamp))
}
